        ...
        <div class="form-box login">
            ...
            <div class="form-content">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" name="login" id="log">Log In</button>
                </form>
...
<div>
    <h3 style="margin-left:245px;color:white;">CHECK LATEST FOOD ARTICLES:</h3>
</div>
        <div class="news-container" id="news-container" style="margin-left:100px;">
...
<h1 style="color:white">Submit a Review About our page</h1>
...
function showNextNewsItem() {
    newsItems[curr].classList.remove('active');
    curr = (curr + 1) % totalItems;
    newsItems[curr].classList.add('active');
}

setInterval(showNextNewsItem, 10000); // Change news item every 5 seconds
</script>
    </div>
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                ?>
                <script>
                     if(headingButton.textContent="LOG IN")
                     {
                headingButton.textContent = "LOG OUT";
                     }
...
const signupLoginLink = formPopup.querySelectorAll(".bottom-link a");
 ...
 showPopupBtn.addEventListener("click", () => {
    ...
    if(headingButton.textContent=="LOG OUT")
    {
        if (<?php echo isset($_SESSION['email']) ? 'true' : 'false'; ?>) {
        headingButton.textContent = "LOG IN"; // Change button text to "Logout"
    }
