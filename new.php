...
<body>
    ...
    <div class="slider">
        <ul>
            <li><img src="food4.jpg" alt="Slide 1"></li>
            <li><img src="food5.jpg" alt="Slide 2"></li>
            <li><img src="food6.jpg" alt="Slide 3"></li>
        </ul>
        <div class="controls">
